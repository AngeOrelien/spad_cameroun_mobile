...
import 'package:spad_cameroun_mobile/core/config/env_config.dart';
...
void main() async {
  ...
  runApp(const ProviderScope(child: SpadCamerounMobile()));
}

class SpadCamerounMobile extends StatelessWidget {
  const SpadCamerounMobile({super.key});
